# design-context（interview / インタビュー一覧）

## 取得情報

- 取得日: 2026-06-19
- 取得ノード: `1:2`（1920w light / インタビューページ）
...
2. ページイントロ（`1:152`）— パンくず + h1「インタビュー」
3. カテゴリフィルター（`1:51`）— ニュース / 社員紹介 / インタビュー
4. 記事一覧（`1:90`–`1:149`）— 3件カード、3列グリッド
5. CTA — カジュアル面談 + エントリー
6. フッター — トップと共通
...
- 記事グリッド: pt 100px / pb 101px、3列グリッド（3件表示）

## 画像

| 用途 | パス |
|------|------|
| 記事1 | `recruit/blog-01.png` |
| 記事2 | `recruit/blog-05.png` |
| 記事3 | `recruit/blog-08.png` |

## 実装ファイル

- HTML: `src/templates/blog-interview.html` → `src/blog-interview.html`
- SCSS: `src/sass/pages/blog-interview/_blog-interview-page.scss`
